...
ass = {
    ...
    'B01AC06',  # Acetylsalicylsäure (Thrombozytenaggregationshemmer)
...
diltiazem = {
    'C08DB01',  # Diltiazem
    'C05AE03'   # Diltiazem (Muskelrelaxans)
}
...
digitoxin = {
    'C01AA04',  # Digitoxin
    'C05BZ05',  # Digitoxin (Andere Venenmittel zur topischen Anwendung)
...
ramipril = {
    'C09AA05',  # Ramipril
    'C09BX03',  # Ramipril, Amlodipin und Hydrochlorothiazid
    'C09BB07',  # Ramipril und Amlodipin Standarddosis: 1 DE O
    'C09BA05',  # Ramipril und Diuretika
    'C09BB05',  # Ramipril und Felodipin Standarddosis: 1 DE O
    'C09BA25',  # Ramipril und Hydrochlorothiazid Standarddosis: 1 DE O
